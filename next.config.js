  ...
  async redirects() {
    return [
      ...
      //----------
      {
        source: "/resume",
        destination:
          "https://drive.google.com/file/d/1A0NB0oUfPFWFePJpGePl8-5dc4voH8Sx/view?usp=sharing",
        permanent: false,
        basePath: false,
      },
      {
      ...
      },
      {
        source: "/wakandapp",
        destination:
          "https://play.google.com/store/apps/details?id=com.african_founders.Wakanda",
        permanent: false,
        basePath: false,
      },
      {
        source: "/ebimarketapp",
        destination:
          "https://play.google.com/store/apps/details?id=com.ebimarketplaceapp.ebimarketplace",
        permanent: false,
        basePath: false,
      },
      {
      ...
      },
      {
        source: "/interpocket",
        destination:
          "https://play.google.com/store/apps/details?id=com.interpocket.v1",
        permanent: false,
        basePath: false,
      },
      {
        source: "/cydene",
        destination:
          "https://play.google.com/store/apps/details?id=com.cydeneexpress",
        permanent: false,
        basePath: false,
      },
      ...
      },
      {
        source: "/crestbase",
        destination:
          "https://play.google.com/store/apps/details?id=com.crestbase.crestbasemobileapp&pcampaignid=web_share",
        permanent: false,
        basePath: false,
      },
      {
        source: "/liveeasy",
        destination:
          "https://play.google.com/store/apps/details?id=com.simplepark.live_easy",
        permanent: false,
        basePath: false,
      },
      {
      ...
      {
        source: "/powerupapp",
        destination: "https://qrs.ly/d8chict",
        permanent: false,
        basePath: false,
      },
      {
        source: "/wakandabusinessapp",
        destination:
          "https://play.google.com/store/apps/details?id=wakandabusiness.app&hl=en_US",
        permanent: false,
        basePath: false,
      },
    ];
